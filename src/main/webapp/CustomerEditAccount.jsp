...
Long accountno=Long.parseLong(account);
HttpSession hs=request.getSession();
hs.setAttribute("editaccount", accountno);
...
<form action="customerupdate" method="post"> 
 ...
 <a href="CustomerHomePage.html"><span style="color:white">Back</span></a>
...
<%
 ...
 else
 {
	 ...
	 RequestDispatcher rd=request.getRequestDispatcher("CustomerEditAccount.html");
